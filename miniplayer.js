const MP={
    init(){
        ...
        <div id="mini-player" class="hidden fixed left-3 right-3 z-50" style="bottom:80px;transition:transform 0.35s ease-out;transform:translateY(40px);">
            <div class="rounded-2xl p-3 flex items-center gap-3 cursor-pointer active:scale-[0.98] transition relative overflow-hidden" style="background:rgba(30,30,30,0.95);backdrop-filter:blur(20px);border:1px solid rgba(255,255,255,0.1);box-shadow:0 10px 40px rgba(0,0,0,0.6);">
