const FullPlayer={
    init(){
        ...
        <div id="full-player" class="fixed flex flex-col z-[100]" style="display:none;background:rgba(10,10,10,0.95);backdrop-filter:blur(40px);-webkit-backdrop-filter:blur(40px);transition:transform 0.35s ease-out;transform:translateY(100%);top:0;left:0;width:100%;height:100%;overflow:hidden;touch-action:none;">
        ...
        <div id="lyrics-overlay" class="fixed flex flex-col z-[200]" style="display:none;background:rgba(10,10,10,0.98);backdrop-filter:blur(50px);-webkit-backdrop-filter:blur(50px);transition:transform 0.35s ease-out;transform:translateY(100%);top:0;left:0;width:100%;height:100%;overflow:hidden;touch-action:none;">
